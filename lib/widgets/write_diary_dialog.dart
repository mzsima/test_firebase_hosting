...
class WriteDiaryDialog extends StatefulWidget {
  ...
  }) : _titleTextController = titleTextController, _descriptionTextController = descriptionTextController, super(key: key);
...
class _WriteDiaryDialogState extends State<WriteDiaryDialog> {
  ...
  CollectionReference diaryCollectionReference = FirebaseFirestore.instance.collection('diaries');
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    firebase_storage.FirebaseStorage fs = firebase_storage.FirebaseStorage.instance;
                    final dateTime = DateTime.now();
                    final path = '$dateTime';

                    final _fieldsNotEmpty = widget._titleTextController.text.isNotEmpty && widget._descriptionTextController.text.isNotEmpty;
                    

                    if (_fieldsNotEmpty) {
                      diaryCollectionReference.add(
                        Diary(
                    ...
                    if (_fileBytes != null) {
                      ...
                      Future.delayed(Duration(milliseconds: 1500))
                        .then((value) {
                          fs.ref()
                            .child('image/$path${FirebaseAuth.instance.currentUser!.uid}')
                    ...
                    Future.delayed(Duration(milliseconds: 2500)).then((value) => Navigator.of(context).pop());
                  }, 
                ),
              )
            ],
